...
func Execute(ctx context.Context) error {
	...
	root.AddCommand(newPushCommand(ctx, manager))
	root.AddCommand(newImportCommand(ctx, manager))
	root.AddCommand(newBucketCommand(ctx, manager))
	root.AddCommand(newWorkspaceCommand(ctx, manager))
